...
(session-design.md, Caching). The refresh here is non-concurrent because it
runs inside the request transaction; the scheduler's five minute refresh is
the concurrent one. The Redis JSON cache layer is deferred with the M2
